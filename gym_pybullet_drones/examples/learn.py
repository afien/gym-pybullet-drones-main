...
#                 verbose=1
#                 )
#     model.learn(total_timesteps=200000) # Typically not enough (2000 = 1epoch)
...
from gym_pybullet_drones.envs.single_agent_rl.BaseSingleAgentAviary import shared_constants
